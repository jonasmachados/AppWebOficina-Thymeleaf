...
//            //            + "lower(CONCAT(m.razaoSocial, ' ', m.cpf_Cnpj, ' ', m.cep, ' ', m.endereco, ' ', m.numero, ' ', m.bairro, ' ', m.cidade, ' ', m.telefone, ' ',  m.adicionais, ' ', m.dataCriacao, ' '))"
//            + "CONCAT(m.id, m.razaoSocial, m.cpf_Cnpj, m.cep, m.endereco)"
//            + " LIKE %?1%")

...
public class NotaServico implements Serializable {
    ...
    //CONSTRUCTOR
    public NotaServico(Integer id, String descricao, Double preco, Date dataServico, Double km, Mecanico mecanico, Carro carro) {
        this.id = id;
    ...
    public boolean equals(Object obj) {
        ...
        final NotaServico other = (NotaServico) obj;
